...
export const loadReviewAgent: AgentLoader = async (): Promise<AgentConfig> => {
  return {
    ...
    greeting:
      "Start by saying something like 'Let's review your flashcards!' then get the first flashcard using the get_random_flashcard tool and begin quizzing the user.",
  };
};
