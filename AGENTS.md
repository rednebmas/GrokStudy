This application is a voice that helps users learn by creating flashcards for you as they explore topics and uses spaced repetition to quiz them, ensuring that they remember what they learn.
...
-   **Encapsulation**: Components should own their own logic. If a component needs to compute something from props (like whether to show itself, or how to render data), that logic belongs inside the component—not in the parent.
